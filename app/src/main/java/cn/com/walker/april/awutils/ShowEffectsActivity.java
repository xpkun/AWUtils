...
import com.common.utils.nine.effects.Effectstype;
import com.common.utils.nine.effects.NiftyDialogBuilder;
...
public class ShowEffectsActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.showeffect_activity);
...
//                .withMessage("This is a modal Dialog.")                     //.withMessage(null)  no Msg
                ...
                .withIcon(getResources().getDrawable(R.drawable.btn_press))
